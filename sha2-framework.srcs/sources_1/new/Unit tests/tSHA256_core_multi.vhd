...
--! @brief Selectable Test bench for the SHA-256 hash core
--! @details The test case can be selected by means of a constant
...
--	constant TEST         : string  := "064";
	--! Whether or not the oracle must be verified by means of VHDL assert
